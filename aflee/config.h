...
/* File deskriptors to be used for passing terminal assert flag
   (the application will use TASSERT_FD and TASSERT_FD + 1): */

#define TASSERT_FD          222
